...
2. **选择区域**：底部切换自然灾害、公共安全、居家校园办公三张地图。地图从下方向上探索。
3. **点击节点**：选择可进入的关卡，阅读简短介绍，再点“进入场景”。
...
| 彩色花苞、柔和提示 | 已解锁，可以进入 |
| 盛开的红花与完成标记 | 已完成，可以重玩，不重复领取首次奖励 |

解锁以具体关卡的前置条件为准，不是点击任何节点都能进入。点击地图顶部游戏标题回首页；花朵数字打开守护档案；奖杯打开本机排行榜。
...
声音通常在首次点击后启用。首页按钮控制结算与种花音效；关内音乐和环境声由对应关卡的暂停菜单控制。离开时可以直接关闭页面。
...
| 地图 | 数量 | 关卡 |
| --- | ---: | --- |
| 自然灾害 | 11 | 台风前的家、汛期应急包、日常家庭防震准备、风雨中的街口、雷雨来临的公园、林缘的五处火源、暴雨前的街道、洪水围困、地震室内避险、震动停止后的撤离、洪水围困待援 |
| 公共安全 | 7 | 畅通的生命通道、电梯停住了、井口边的求助、让生命通道畅通、汽车落水离车、电梯被困求助、塌陷被困求救 |
| 居家校园办公 | 6 | 厨房着火了、充电中的卧室、睡前的卧室、开火前的厨房、隔烟与定位待援、沿可用楼梯撤离 |

名称相近也可能是不同任务，例如“畅通的生命通道”练习处置，“让生命通道畅通”练习识别。仓库内还包含未启用草稿和制作工具，它们不计入正式地图，不代表已审校可玩。
