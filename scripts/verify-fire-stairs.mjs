...
const out=path.join(root,'docs/fire-stairs-refinement/verification');fs.mkdirSync(out,{recursive:true});
...
jobs.push(['scripts/test-fire-stairs.mjs'],['scripts/test-fire-shelter.mjs'],['scripts/test-typhoon-immersion.mjs'],['node_modules/typescript/bin/tsc','--noEmit']);
