...
- SHA-256：d2beb638a741be352f2915350a9f95cdb01e491c717a1b23d889abbbc0f221d8
- 浏览器：152.0.7977.83；独立 headless、offline、--mute-audio。
- finally 关闭 contexts：4/4；browser：true。
...
- [mine-320x568-scrolled.png](mine-320x568-scrolled.png)
...
- [board-320x568-scrolled.png](board-320x568-scrolled.png)
- [board-1440x900.png](board-1440x900.png)
- [complete-390x844.png](complete-390x844.png)
